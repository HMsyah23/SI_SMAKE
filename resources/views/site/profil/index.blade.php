            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        <h1 class="text-capitalize mb-5 text-lg">{{ $profil->nama ?? 'Tidak Ada' }}</h1>
                        ...
                        <ul class="list-inline breadcumb-nav">
							...
							@else
							<li class="list-inline-item"><a href="{{ url('/profil/' . $profil->slug) }}"
								class="text-white-50">{{ $profil->nama ??'Tidak Ada' }}</a>
							</li>
							@endif
            ...
            <div class="row">
                {{-- <div class="col-lg-4 col-md-6">
                    <div class="doctor-img-block">
                        ...
                        <div class="sidebar-widget category mt-4">
                             <h4 class="mb-0">Alexandar james</h4>
                            <p>Orthopedic Surgary</p> 

                            <ul class="list-unstyled">
                                <li class="align-items-center">
                                    <a href="{{ url('/profil/' . $profil->slug) }}">{{ $profil->nama }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="doctor-details mt-4 mt-lg-0">
                        <h2 class="text-md">{{ $profil->nama ?? 'Tidak Ada' }}</h2>
                        <div class="divider my-4"></div>
                        <div>
                            {!! $profil->body ?? 'Tidak Ada' !!}
                        </div>
                    </div>
                </div>
            </div>
