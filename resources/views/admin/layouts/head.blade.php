...
<head>
    ...
    <title>Admin | Unit Pelaksana Teknis Daerah Tahura Bukit Soeharto</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                <button class="navbar-toggler navbar-toggler align-self-center" id="navToogle" type="button"
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="{{ Auth::user()->picture != null ? '/' . Auth::user()->picture : asset('assets/admin/images/faces/face28.jpg') }}"
                                alt="profile" />
                        </a>
