    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h4 class="modal-title text-center mb-5"> Tambah Data <small class="text-primary"><i class="ti-user"></i> Informasi</small></h4>
          <form class="form-sample" method="" enctype="multipart/form-data" id="ajaxSubmit">
            @csrf
            <div class="row">
              <div class="col-md-12 mb-3">
                <label class="form-label">Nama*</label>
                <input required type="text" id="nama" class="form-control form-control-sm" placeholder="Masukkan Nama Informasi"/>
              </div>
              <div class="col-md-12 mb-3">
              ...
              <div class="col-md-12 mb-3">
                <div class="form-group">
                  ...
                  <div class="input-group col-xs-12">
                    <input id="uploadimage" type="text" class="form-control form-control-sm file-upload-info" disabled placeholder="Upload Foto Informasi">
...
@push('js')
  <script>
          ...
          { 
            ...
            "render": function ( data, type, row, meta ) {
                return `<div class="btn-group" role="group" aria-label="Basic example">
                        <a href="informasi/${data}/edit" class="btn btn-outline-primary">
                          <i class="ti-eye"></i>
                        </a>
                      </div>`;
            }
    ...
    function deleteFunction(id){
        Swal.fire({
            icon: 'info',
            title: `Apakah Kamu Ingin Menghapus Informasi Ini ?`,
            showDenyButton: true,
