            ...
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0"><a href="{{ route('dashboard') }}">Dashboard</a> / <a
                            href="/admin/profil"> Profil</a> / <i class="ti-announcement"></i> {{ $profil->nama }}</h6>
                </div>
                                ...
                                <table class="table table-striped table-borderless">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="mb-0"><span
                                                        class="font-weight-bold nama">{{ $profil->nama }}</span></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="pl-2">Link</td>
                                            <td>
                                                <p class="mb-0"><a href="{{ url('profil/' . $profil->slug) }}"
                                                        target="_blank"
                                                        class="font-weight-bold slug">{{ url('profil/' . $profil->slug) }}</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input required type="text" id="nama" class="form-control form-control-sm"
                                            placeholder="Masukkan Nama Profil " value="{{ $profil->nama }}" />
                                    </div>
                                    <div class="col-md-12 mb-5">
            ...
            $('#ajaxSubmit').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $('.slug').text(`https://${document.location.host}/profil/${result.data.slug}`);
                        $('.slug').attr('href',`/profil/${result.data.slug}`);
                    },
