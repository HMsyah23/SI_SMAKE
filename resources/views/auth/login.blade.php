...
<head>
  ...
  <title>UPTD Tahura Bukit Soeharto | Login</title>
  <!-- plugins:css -->
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4 class="text-center">Unit Pelaksana Teknis Dinas <br> Tahura Bukit Soeharto</h4>
              <small class="font-weight-light">Silahkan login terlebih dahulu</small>
